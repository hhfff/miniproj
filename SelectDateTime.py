...
#codes for this class was derived from Qt Designer
...
class OpenSelectDateTimeWindow(QtWidgets.QWidget, Ui_SelectDateTime, QtCore.QDate):
    #set global main day, month, year
    ...
    def __init__(self):
        ...
        self.pushButtonConfirm.clicked.connect(self.userSelectedDate)
    ...
    #this function is to return user chosen date
