...
class DigitalClock(QtWidgets.QWidget, Ui_widget_DigitalClock):
    ...
    def showDate(self):
        ...
        # example (Wednesday, 06 November, 2019)
        textDate = date.toString("dddd, dd MMMM, yyyy")
        # update label_CurrentDate with textDate string
    ...
    def showTime(self):
        ...
        # update label_DigitalClock with textTime string
...
if __name__ == "__main__":
    ...
    DigitalClockWidget = DigitalClock()
