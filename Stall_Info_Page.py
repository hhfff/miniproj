...
# Page UI designed using PyQt5 Desinger and coded by Shah, parts done by others are stated specifically and boxed up
...
class Ui_Stall_Info_Window(object):
    ...
    def retranslateUi(self, Stall_Info_Window):
       ...
       ############################################################################################################
        ...
        Stall_Info_Window.setWindowTitle(_translate("Stall_Info_Window", "Stall Information Page"))
