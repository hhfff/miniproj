...
class Ui_Stall_Info_Window(object):
    ...
    def retranslateUi(self, Stall_Info_Window):
        ...
        self.label_stallOpHour.setText(_translate("Stall_Info_Window", "Full Operation Hours: " + self.stall.getAllOperationHoursInString()))
...
if __name__ == "__main__":
    ...
    ui.setupUi(Stall_Info_Window,'h')
