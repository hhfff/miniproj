...
class Ui_Stall_Info_Window(object):
    def setupUi(self, Stall_Info_Window):
        ...
        self.btn_home = QtWidgets.QPushButton(self.windowFrame)
        self.btn_home.setGeometry(QtCore.QRect(660, 740, 141, 41))
        self.btn_home.setObjectName("btn_home")

        #home button clicked
        self.btn_home.clicked.connect(self.func_home)
    ...
    def retranslateUi(self, Stall_Info_Window):
        ...
        stall_det = Stall.fetchStalls(2,'13:00:00')

        for i in stall_det:
            print(i.name,i.description,i.all_operation_hours)
            self.label_stallName.setText(_translate("Stall_Info_Window", "Stall Name: " + i.name))
            self.label_stallDesc.setText(_translate("Stall_Info_Window", "Description: " + i.description))
            self.label_stallOpHour.setText(_translate("Stall_Info_Window", "Full Operation Hours: " + str(i.all_operation_hours)))
        ...
        self.btn_home.setText(_translate("Stall_Info_Window", "Home"))
        self.label_RTC_Clock.setText(_translate("Stall_Info_Window", "Clock"))
    ...
    def showTime(self):
        ...
        self.label_RTC_Clock.setText("Current Time: " + text + " h")
    ...
    def error_message(self, message):
        # disable Stall Page
        Stall_Info_Window.setEnabled(False)
...
if __name__ == "__main__":
    ...
    ui.setupUi(Stall_Info_Window)

    #for live running timer
    timer = QtCore.QTimer(Stall_Info_Window)
    timer.timeout.connect(lambda: ui.showTime())
    timer.start(1000)
